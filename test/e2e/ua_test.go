...
func TestUA_YealinkClassified(t *testing.T) {
	...
	require.Equal(t, float64(100), inviteTotal, "loopback doubles INVITE count")
...
func TestUA_MultipleTypesIsolated(t *testing.T) {
	...
	require.Equal(t, float64(100), yealinkInvite)
	require.Equal(t, float64(100), grandstreamInvite)
...
func TestUA_OtherWhenNoUAHeader(t *testing.T) {
	...
	require.Equal(t, float64(100), inviteTotal, "no UA header → ua_type=other")
...
func TestUA_NoConfigAllOther(t *testing.T) {
	...
	require.Equal(t, float64(100), inviteTotal, "without config → all ua_type=other")
...
func TestUA_SDC_ByUAType(t *testing.T) {
	...
	require.Equal(t, float64(50), sdc, "SDC = completed sessions (dialog deletion dedup on loopback)")
...
func TestUA_CarrierAndUALabelsCombined(t *testing.T) {
	...
	require.Equal(t, float64(100), inviteCarrierUA, "loopback doubles INVITE; both labels present")
	...
	require.Equal(t, float64(50), sdcCarrierUA, "SDC with both labels (dialog dedup on loopback)")
