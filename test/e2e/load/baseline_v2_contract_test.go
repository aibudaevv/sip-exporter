...
func TestThresholdPolicyClassifiesCanonicalResourceMetrics(t *testing.T) {
	tests := []struct {
		...
		{name: "post-drain channel", scenario: "TestReleaseSoak", metric: "post_drain_channel_length"},
		{name: "post-drain dialogs", scenario: "TestReleaseSoak", metric: "post_drain_active_dialogs"},
		{name: "post-drain trackers", scenario: "TestReleaseSoak", metric: "post_drain_active_trackers"},
