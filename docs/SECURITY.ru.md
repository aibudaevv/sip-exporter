...
## Область действия и границы данных
...
Требуется привилегированное развёртывание на Linux-хосте, который видит SIP-сигнализацию по IPv4/UDP
и связанный RTP/RTCP-трафик. Сервис не сохраняет пакеты или аудио и не предоставляет интерфейс
...
- **Не** открывает входящие порты, кроме эндпоинтов `/metrics` и `/health` на настроенном HTTP-порту (по умолчанию 10047)
